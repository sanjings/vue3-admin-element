...
export const useTagsViewStore = defineStore("tagsView", () => {
  ...
  function delOtherCachedViews(view: TagView): Promise<string[]> {
  ...
  async function addView(view: TagView) {
    await addVisitedView(view);
    addCachedView(view);
  }
