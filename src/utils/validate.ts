 ...
 * 手机号校验
 */
export const validatePhone: FormItemRule["validator"] = (
  rule,
  value,
  callback,
) => {
 ...
 * 身份证校验
 */
export const validateIdCard: FormItemRule["validator"] = (
  rule,
  value,
  callback,
) => {
 ...
 * 电子邮箱校验
 */
export const validateEmail: FormItemRule["validator"] = (
  rule,
  value,
  callback,
) => {
 ...
 * 网址链接校验
 */
export const validateWebsite: FormItemRule["validator"] = (
  rule,
  value,
  callback,
) => {
 ...
 * 汉字、英文校验
 */
export const validatePassword: FormItemRule["validator"] = (
  rule,
  value,
  callback,
) => {
